...
import com.ztech.core.cache.SimpleCache;
...
public class PatternPool {
    ...
    public static final Pattern PLATE_NUMBER = Pattern.compile("^(([京津沪渝冀豫云辽黑湘皖鲁新苏浙赣鄂桂甘晋蒙陕吉闽贵粤青藏川宁琼使领][A-Z](([0-9]{5}[DF])|([DF]([A-HJ-NP-Z0-9])[0-9]{4})))|([京津沪渝冀豫云辽黑湘皖鲁新苏浙赣鄂桂甘晋蒙陕吉闽贵粤青藏川宁琼使领][A-Z][A-HJ-NP-Z0-9]{4}[A-HJ-NP-Z0-9挂学警港澳使领]))$");
    ...
    private static class RegexWithFlag {
        ...
        public int hashCode() {
            int prime = true;
            int result = 1;
            int result = 31 * result + this.flag;
        ...
        public boolean equals(Object obj) {
            if (this == obj) {
                ...
                PatternPool.RegexWithFlag other = (PatternPool.RegexWithFlag)obj;
